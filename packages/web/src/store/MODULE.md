...
- product/module functionality: Track selected email, action-chat state, and sidebar state.
...
- local validation commands/checks: `rg -n "sidebarCollapsed" packages/web/src`, `npx tsc -p packages/web/tsconfig.json --noEmit`.
